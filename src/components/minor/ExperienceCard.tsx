...
import JyskLogoSvg from "../../assets/images/jysk.svg";
...
const ExperienceCard = ({
  ...
  return (
    <div className="col-span-3 row-span-1 xl:col-span-1 transition duration-300 ease-in-out shadow-xl rounded-xl bg-gradient-to-t p-[3px] dark:from-[#43cea2] dark:to-[#185a9d] from-[#ff7e5f] to-[#feb47b] mx-2 h-full">
