...
const ContactMeButton = () => {
  return (
    <div
      ...
      className="w-14 h-14 shadow-xl cursor-pointer rounded-xl bg-gradient-to-r p-1 dark:from-[#43cea2] dark:to-[#185a9d] from-[#ff7e5f] to-[#feb47b] hover:scale-125  transition-all duration-300 ease-in-out"
    >
